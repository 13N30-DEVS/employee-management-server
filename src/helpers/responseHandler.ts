...
const httpStatusCodes: Record<string, { code: number; description: string; message?: string }> = {
  OK: {
    code: 200,
    description: 'The request has succeeded.',
    message: constants.HTTP_MESSAGES.SUCCESS.FETCHED,
  },
  CREATED: {
    code: 201,
    description: 'The request has been fulfilled, resulting in the creation of a new resource.',
    message: constants.HTTP_MESSAGES.SUCCESS.CREATED,
  },
  ACCEPTED: {
    code: 202,
    description:
...
function handleResponse(
  ...
  const { headers = 'application/json', data = {}, error = {}, customMessage } = options;
