...
export type workspace_shiftOptionalAttributes =
  | 'workspace_id'
  | 'name'
  | 'description'
  | 'is_active'
  ...
  | 'deleted_by'
  | 'deleted_at';
export type workspace_shiftCreationAttributes = Optional<
  workspace_shiftAttributes,
  workspace_shiftOptionalAttributes
>;

export class workspace_shift
  extends Model<workspace_shiftAttributes, workspace_shiftCreationAttributes>
  implements workspace_shiftAttributes
{
  id!: string;
  workspace_id?: string;
  name?: string;
