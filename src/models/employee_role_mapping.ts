...
export type employee_role_mappingOptionalAttributes =
  | 'emp_id'
  | 'role_id'
  | 'is_active'
  | 'is_deleted'
  ...
  | 'deleted_by'
  | 'deleted_at';
export type employee_role_mappingCreationAttributes = Optional<
  employee_role_mappingAttributes,
  employee_role_mappingOptionalAttributes
>;

export class employee_role_mapping
  extends Model<employee_role_mappingAttributes, employee_role_mappingCreationAttributes>
  implements employee_role_mappingAttributes
{
  id!: string;
  emp_id?: string;
  role_id?: number;
