...
export type master_departmentOptionalAttributes =
  | 'name'
  | 'description'
  | 'is_active'
  | 'created_at'
  | 'updated_at';
export type master_departmentCreationAttributes = Optional<
  master_departmentAttributes,
  master_departmentOptionalAttributes
>;

export class master_department
  extends Model<master_departmentAttributes, master_departmentCreationAttributes>
  implements master_departmentAttributes
{
  id!: number;
  name?: string;
  description?: string;
