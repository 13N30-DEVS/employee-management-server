...
export class workspace_department
  extends Model<workspace_departmentAttributes, workspace_departmentCreationAttributes>
  implements workspace_departmentAttributes
{
  ...
  // workspace_department belongsTo user via created_by
  created_by_user!: user;
  getCreated_by_user!: Sequelize.BelongsToGetAssociationMixin<user>;
  setCreated_by_user!: Sequelize.BelongsToSetAssociationMixin<user, userId>;
  createCreated_by_user!: Sequelize.BelongsToCreateAssociationMixin<user>;
  // workspace_department belongsTo user via deleted_by
  ...
  // workspace_department belongsTo user via updated_by
