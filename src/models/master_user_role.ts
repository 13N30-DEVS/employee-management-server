...
export type master_user_roleOptionalAttributes = "name" | "description" | "is_active" | "created_at" | "updated_at";
export type master_user_roleCreationAttributes = Optional<master_user_roleAttributes, master_user_roleOptionalAttributes>;

export class master_user_role extends Model<master_user_roleAttributes, master_user_roleCreationAttributes> implements master_user_roleAttributes {
  id!: number;
  name?: string;
  description?: string;
  is_active?: boolean;
