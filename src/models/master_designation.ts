...
export type master_designationOptionalAttributes = "name" | "description" | "is_active" | "created_at" | "updated_at";
export type master_designationCreationAttributes = Optional<master_designationAttributes, master_designationOptionalAttributes>;

export class master_designation extends Model<master_designationAttributes, master_designationCreationAttributes> implements master_designationAttributes {
  id!: number;
  name?: string;
  description?: string;
  is_active?: boolean;
