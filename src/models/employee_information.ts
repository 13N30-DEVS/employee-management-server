...
export class employee_information extends Model<employee_informationAttributes, employee_informationCreationAttributes> implements employee_informationAttributes {
  ...
  removeEmployee_detail!: Sequelize.HasManyRemoveAssociationMixin<employee_detail, employee_detailId>;
  removeEmployee_details!: Sequelize.HasManyRemoveAssociationsMixin<employee_detail, employee_detailId>;
  ...
  setEmployee_role_mappings!: Sequelize.HasManySetAssociationsMixin<employee_role_mapping, employee_role_mappingId>;
  addEmployee_role_mapping!: Sequelize.HasManyAddAssociationMixin<employee_role_mapping, employee_role_mappingId>;
  addEmployee_role_mappings!: Sequelize.HasManyAddAssociationsMixin<employee_role_mapping, employee_role_mappingId>;
  createEmployee_role_mapping!: Sequelize.HasManyCreateAssociationMixin<employee_role_mapping>;
  removeEmployee_role_mapping!: Sequelize.HasManyRemoveAssociationMixin<employee_role_mapping, employee_role_mappingId>;
  removeEmployee_role_mappings!: Sequelize.HasManyRemoveAssociationsMixin<employee_role_mapping, employee_role_mappingId>;
  hasEmployee_role_mapping!: Sequelize.HasManyHasAssociationMixin<employee_role_mapping, employee_role_mappingId>;
  hasEmployee_role_mappings!: Sequelize.HasManyHasAssociationsMixin<employee_role_mapping, employee_role_mappingId>;
